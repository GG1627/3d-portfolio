  ...
  return (
    <>
      ...
      <Canvas onClick={handleZoomClick} shadows>
        ...
        />
        <OrbitControls
          minPolarAngle={toRadians(-90)} // Minimum polar angle (30 degrees)
          maxPolarAngle={toRadians(70)} // Maximum polar angle (90 degrees)
          minAzimuthAngle={toRadians(0)} // Minimum azimuthal angle (-90 degrees)
          maxAzimuthAngle={toRadians(90)} // Maximum azimuthal angle (90 degrees)
          enableZoom={false}
        />
