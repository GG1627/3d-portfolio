...
export default class EditInit {
  ...
  isClicked: boolean;
  isLerping: boolean; // New flag for tracking if camera is lerping
  ...
  constructor(canvasId: string, isClicked: boolean) {
    ...
    this.isLerping = false; // Initialize as false
    this.lerpSpeed = 0.03;
    ...
    this.targetPosition = new THREE.Vector3(-80, 50, 110);
  }
  ...
  startLerp(toPosition: THREE.Vector3) {
    this.targetPosition = toPosition;
    this.isLerping = true; // Begin lerping
  }
