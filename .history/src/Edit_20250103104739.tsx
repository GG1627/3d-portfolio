...
function Edit() {
  ...
  const [isLerping, setIsLerping] = useState(true); // New state for lerping
  ...
  const handleButtonClick = () => {
    ...
    setIsLerping((prev) => !prev);
    // Example logic to toggle isLerping after 1 second
    // setTimeout(() => setIsLerping((prev) => !prev), 1000);
  };
