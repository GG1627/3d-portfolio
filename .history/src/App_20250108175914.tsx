  ...
  return (
    <>
      ...
      <div className="controls">
        ...
        <button onClick={handleLightButtonClick} className="mybutton2">
          {" "}
          {isDarkMode ? (
            <MdSunny size={30} color="black" />
          ) : (
            <MdModeNight size={30} color="black" />
          )}
        </button>
      </div>
      ...
      <Canvas onClick={handleZoomClick} shadows>
        ...
        <Suspense fallback={null}>
          ...
          >
            ...
            <meshStandardMaterial color={isDarkMode ? "black" : "#c4c4c4"} />
          </mesh>
          ...
          >
            <planeGeometry args={[200, 200]} />
            <meshStandardMaterial color={isDarkMode ? "red" : "#c4c4c4"} />
          </mesh>
        </Suspense>
