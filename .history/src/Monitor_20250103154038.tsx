...
export function loadMonitor(scene: THREE.Scene) {
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      model.scale.set(1.3, 1.3, 1.3); // Adjust scale as needed
      model.position.set(0, 1.2, 0); // Set position for the monitor
      ...
      screenHtml.innerHTML = `<iframe src="https://bruno-simon.com/" style="width:100%; height:100%; border:none;"></iframe>`;
