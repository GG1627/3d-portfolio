...
export default class EditInit {
  ...
  constructor(canvasId: string, isClicked: boolean) {
    ...
    this.lerpSpeed = 0.005; // Adjust this value to make the transition faster or slower
    ...
    this.targetPosition = new THREE.Vector3(-80, 50, 50); // Initial target position
  }
  ...
  initialize() {
    ...
    this.camera.position.set(-80, 50, 50);
  ...
  animate() {
    ...
    if (this.isClicked) {
      this.targetPosition = new THREE.Vector3(-80, 50, 50); // Target position when clicked
