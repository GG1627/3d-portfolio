  ...
  return (
    <div className="mainWindow">
      ...
      >
        ...
        <directionalLight
          position={[10, 50, 10]} // Elevate the light to cast more pronounced shadows
          castShadow
          shadow-mapSize-width={1024} // Shadow map resolution
          shadow-mapSize-height={1024}
          shadow-camera-near={1}
          shadow-camera-far={200} // Increase range if necessary
          shadow-camera-left={-100} // Adjust bounds to fit your scene
